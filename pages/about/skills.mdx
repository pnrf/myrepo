...
**Предметная область:** разработка веб-приложений, онлайн-сервисов и баз знаний  
**Стиль изложения:** официально-деловой  

В 2023 году пришлось коснуться темы сверточных нейронных сетей и компьтерного зрения для медицины. Поверхностно. Код не читал. Задачи по документированию выполнял успешно. Но ИИ – не моя предметная область, а python – пока не мой стек. Готов погружаться в них только по рабочей нужде.

Веб-разработку учил, учу и собираюсь учить в будущем. Интересно создавать удобные веб-приложения, наполнять их качественным контентом, описывать архитектуру цифрового продукта, логику взаимодействия его компонентов, модулей и баз данных.
