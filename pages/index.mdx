...
До этого 20 лет отработал юристом. Составлял договорную, корпоративную и процессуальную документацию. Моделировал и описывал бизнес-процессы. Консультировал по правовым вопросам.
