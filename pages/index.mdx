...
На этом сайте собрал краткую информацию о себе, [портфолио](./portfolio/), [базу знаний](./knowledgeBase/) и [блог](./blog/), чтобы показать свои умения и навыки на реальных примерах. Это позволяет мне эффективнее общаться с рекрутерами и тимлидами в процессе поиска работы.
